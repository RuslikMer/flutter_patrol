...
void main() {
  ...
  patrolTest(
      'get order with fixed amount voucher',
    ...
    String voucher = await qaApi.generateFixedAmountVoucher('25');
    ...
    int totalPrice = await base.checkout.chooseShippingMethod($, 'express');
