...
void main() {
  ...
  patrolTest(
      'get order by empty wallet card',
    ...
    await base.checkout.chooseShippingMethod($, 'standard');
    await base.checkout.fillCardData($, GlobEnv.buyerStripesPauper);
    await base.checkout.confirmOrder($);
    await base.checkout.waitAlert($, 'Your card was declined', true);
